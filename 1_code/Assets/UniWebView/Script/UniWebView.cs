...
public class UniWebView: MonoBehaviour {
    ...
    public void AddMessagePageStarted(LuaFunction eventPageStart)
    {
        this.OnPageStarted += (view, url) =>
        {
            if (eventPageStart != null)
                eventPageStart.Call(view, url);
        };
    }

    public void EvaluateJS(string actName , LuaFunction successCallBack, LuaFunction failCallBack)
    {
        this.EvaluateJavaScript(actName, (payload) => {
    ...
    public void AddJS(string actFunStr, LuaFunction successCallBack, LuaFunction failCallBack)
    {
        this.AddJavaScript(actFunStr,(payload) =>
        {
            if (payload.resultCode.Equals("0"))
            {
                if(successCallBack != null)
