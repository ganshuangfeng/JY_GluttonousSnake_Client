...
SkillMonsterBossSandWormFireAttack = basefunc.class(Skill)
local M = SkillMonsterBossSandWormFireAttack

function M:Ctor(data)
	M.super.Ctor( self , data )
	self.data = data

	self.boss_skill_id = 4
end
...
function M:AttackTarget()
	...
	local damage = {}
	hit_data.hitOrgin = {pos = Vector3.New(self.object.transform.position.x,self.object.transform.position.y - 3,0)}
