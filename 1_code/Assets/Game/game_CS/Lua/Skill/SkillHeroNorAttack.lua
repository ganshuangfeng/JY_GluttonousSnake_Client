...
SkillHeroNorAttack = basefunc.class(Skill)
local M = SkillHeroNorAttack
...
function M:Aim(dt)
    ...
    if self.object.curDir ~= dir then
        ...
        local call = function (add)
            ...
            if self.object.config.type == 1 or self.object.config.type == 7 or self.object.config.type == 14 
                or self.object.config.type == 16 or self.object.config.type == 17 or self.object.config.type == 19
                ...
                elseif self.object.config.type == 13 then
                    self.object.sprite_spr.sprite = GetTexture("ydl_" .. dirByImg[self.object.curDir+1])
                elseif self.object.config.type == 15 then
                    self.object.sprite_spr.sprite = GetTexture("shb_" .. dirByImg[self.object.curDir+1])
                elseif self.object.config.type == 9 then
                    self.object.sprite_spr.sprite = GetTexture("jtl_" .. dirByImg[self.object.curDir+1])
                elseif self.object.config.type == 20 then
                    self.object.sprite_spr.sprite = GetTexture("kwts_" .. dirByImg[self.object.curDir+1])
                elseif self.object.config.type == 21 then
                    self.object.sprite_spr.sprite = GetTexture("dd_" .. dirByImg[self.object.curDir+1])
                elseif self.object.config.type == 18 then
