...
--远程寄居蟹
SkillMonsterYCJiJuXieAttack = basefunc.class(Skill)
local M = SkillMonsterYCJiJuXieAttack
...
function M:Before()
	...
	self.object.anim_pay:Play("monster_13_attack")
end
...
function M:OnTrigger()
    ...
    --攻击完成
    self:After()
	self.object.anim_pay:Play("monster_13_idel")
end
