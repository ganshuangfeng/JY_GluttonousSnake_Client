...
public class DG_Tweening_DOTweenWrap
{
	...
	static int ToAxis(IntPtr L)
	{
		try
		{
			...
			else if (count == 5)
			{
				...
				float arg2 = (float)LuaDLL.luaL_checknumber(L, 3);
				float arg3 = (float)LuaDLL.luaL_checknumber(L, 4);
				DG.Tweening.AxisConstraint arg4 = (DG.Tweening.AxisConstraint)LuaDLL.luaL_checknumber(L, 5);
	...
	static int set_defaultAutoPlay(IntPtr L)
	{
		try
		{
			DG.Tweening.AutoPlay arg0 = (DG.Tweening.AutoPlay)LuaDLL.luaL_checknumber(L, 2);
	...
	static int set_defaultLoopType(IntPtr L)
	{
		try
		{
			DG.Tweening.LoopType arg0 = (DG.Tweening.LoopType)LuaDLL.luaL_checknumber(L, 2);
	...
	static int set_logBehaviour(IntPtr L)
	{
		try
		{
			DG.Tweening.LogBehaviour arg0 = (DG.Tweening.LogBehaviour)LuaDLL.luaL_checknumber(L, 2);
