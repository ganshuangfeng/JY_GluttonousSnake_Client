...
public class UnityEngine_UI_InputFieldWrap
{
	...
	static int set_contentType(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.UI.InputField obj = (UnityEngine.UI.InputField)o;
			UnityEngine.UI.InputField.ContentType arg0 = (UnityEngine.UI.InputField.ContentType)LuaDLL.luaL_checknumber(L, 2);
	...
	static int set_lineType(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.UI.InputField obj = (UnityEngine.UI.InputField)o;
			UnityEngine.UI.InputField.LineType arg0 = (UnityEngine.UI.InputField.LineType)LuaDLL.luaL_checknumber(L, 2);
			obj.lineType = arg0;
			return 0;
		}
		catch(Exception e)
	...
	static int set_inputType(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.UI.InputField obj = (UnityEngine.UI.InputField)o;
			UnityEngine.UI.InputField.InputType arg0 = (UnityEngine.UI.InputField.InputType)LuaDLL.luaL_checknumber(L, 2);
			obj.inputType = arg0;
			return 0;
		}
		catch(Exception e)
	...
	static int set_keyboardType(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.UI.InputField obj = (UnityEngine.UI.InputField)o;
			UnityEngine.TouchScreenKeyboardType arg0 = (UnityEngine.TouchScreenKeyboardType)LuaDLL.luaL_checknumber(L, 2);
	...
	static int set_characterValidation(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.UI.InputField obj = (UnityEngine.UI.InputField)o;
			UnityEngine.UI.InputField.CharacterValidation arg0 = (UnityEngine.UI.InputField.CharacterValidation)LuaDLL.luaL_checknumber(L, 2);
