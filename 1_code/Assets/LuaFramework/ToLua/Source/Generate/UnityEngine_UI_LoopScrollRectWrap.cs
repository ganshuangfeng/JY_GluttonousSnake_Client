...
public class UnityEngine_UI_LoopScrollRectWrap
{
	...
	static int set_movementType(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.UI.LoopScrollRect obj = (UnityEngine.UI.LoopScrollRect)o;
			UnityEngine.UI.LoopScrollRect.MovementType arg0 = (UnityEngine.UI.LoopScrollRect.MovementType)LuaDLL.luaL_checknumber(L, 2);
	...
	static int set_horizontalScrollbarVisibility(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.UI.LoopScrollRect obj = (UnityEngine.UI.LoopScrollRect)o;
			UnityEngine.UI.LoopScrollRect.ScrollbarVisibility arg0 = (UnityEngine.UI.LoopScrollRect.ScrollbarVisibility)LuaDLL.luaL_checknumber(L, 2);
