...
public class LuaFramework_UtilWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("HMACSHA1Encrypt", HMACSHA1Encrypt);
		...
		L.RegFunction("ClearPluginDir", ClearPluginDir);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int HMACSHA1Encrypt(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
			...
			string o = LuaFramework.Util.HMACSHA1Encrypt(arg0, arg1);
			LuaDLL.lua_pushstring(L, o);
			return 1;
		}
		catch (Exception e)
	...
	static int getDeviceInfo(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 0);
			string[] o = LuaFramework.Util.getDeviceInfo();
			ToLua.Push(L, o);
			return 1;
		}
		catch (Exception e)
	...
	static int CopyFile(IntPtr L)
	{
		try
		{
			...
			string arg0 = ToLua.CheckString(L, 1);
			string arg1 = ToLua.CheckString(L, 2);
			LuaFramework.Util.CopyFile(arg0, arg1);
			return 0;
		}
		catch (Exception e)
		{
	...
	static int MoveFile(IntPtr L)
	{
		try
		{
			...
			string arg0 = ToLua.CheckString(L, 1);
			string arg1 = ToLua.CheckString(L, 2);
			LuaFramework.Util.MoveFile(arg0, arg1);
			return 0;
		}
		catch (Exception e)
		{
	...
	static int CopyDir(IntPtr L)
	{
		try
		{
			...
			string arg0 = ToLua.CheckString(L, 1);
			string arg1 = ToLua.CheckString(L, 2);
			LuaFramework.Util.CopyDir(arg0, arg1);
			return 0;
		}
		catch (Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int ClearPluginDir(IntPtr L)
	{
		try
		{
			...
			LuaFramework.Util.ClearPluginDir(arg0, arg1, arg2);
			return 0;
		}
		catch (Exception e)
		{
