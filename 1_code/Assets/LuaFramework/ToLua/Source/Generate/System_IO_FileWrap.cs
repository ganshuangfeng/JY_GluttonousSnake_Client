...
public class System_IO_FileWrap
{
	...
	static int Open(IntPtr L)
	{
		try
		{
			...
			{
				string arg0 = ToLua.CheckString(L, 1);
				System.IO.FileMode arg1 = (System.IO.FileMode)LuaDLL.luaL_checknumber(L, 2);
			...
			else if (count == 3)
			{
				string arg0 = ToLua.CheckString(L, 1);
				System.IO.FileMode arg1 = (System.IO.FileMode)LuaDLL.luaL_checknumber(L, 2);
				System.IO.FileAccess arg2 = (System.IO.FileAccess)LuaDLL.luaL_checknumber(L, 3);
			...
			else if (count == 4)
			{
				...
				System.IO.FileMode arg1 = (System.IO.FileMode)LuaDLL.luaL_checknumber(L, 2);
				System.IO.FileAccess arg2 = (System.IO.FileAccess)LuaDLL.luaL_checknumber(L, 3);
				System.IO.FileShare arg3 = (System.IO.FileShare)LuaDLL.luaL_checknumber(L, 4);
	...
	static int SetAttributes(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
			string arg0 = ToLua.CheckString(L, 1);
			System.IO.FileAttributes arg1 = (System.IO.FileAttributes)LuaDLL.luaL_checknumber(L, 2);
