...
public class UnityEngine_SceneManagement_SceneManagerWrap
{
	...
	static int UnloadSceneAsync(IntPtr L)
	{
		try
		{
			...
			else if (count == 2 && TypeChecker.CheckTypes<UnityEngine.SceneManagement.Scene, uint>(L, 1))
			{
				UnityEngine.SceneManagement.Scene arg0 = StackTraits<UnityEngine.SceneManagement.Scene>.To(L, 1);
				UnityEngine.SceneManagement.UnloadSceneOptions arg1 = (UnityEngine.SceneManagement.UnloadSceneOptions)LuaDLL.lua_tonumber(L, 2);
