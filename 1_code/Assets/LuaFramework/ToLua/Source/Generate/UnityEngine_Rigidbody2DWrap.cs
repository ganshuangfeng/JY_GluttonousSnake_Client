...
public class UnityEngine_Rigidbody2DWrap
{
	...
	static int AddForce(IntPtr L)
	{
		try
		{
			...
			else if (count == 3)
			{
				UnityEngine.Rigidbody2D obj = (UnityEngine.Rigidbody2D)ToLua.CheckObject(L, 1, typeof(UnityEngine.Rigidbody2D));
				UnityEngine.Vector2 arg0 = ToLua.ToVector2(L, 2);
				UnityEngine.ForceMode2D arg1 = (UnityEngine.ForceMode2D)LuaDLL.luaL_checknumber(L, 3);
	...
	static int AddForceAtPosition(IntPtr L)
	{
		try
		{
			...
			else if (count == 4)
			{
				...
				UnityEngine.Vector2 arg0 = ToLua.ToVector2(L, 2);
				UnityEngine.Vector2 arg1 = ToLua.ToVector2(L, 3);
				UnityEngine.ForceMode2D arg2 = (UnityEngine.ForceMode2D)LuaDLL.luaL_checknumber(L, 4);
	...
	static int set_bodyType(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Rigidbody2D obj = (UnityEngine.Rigidbody2D)o;
			UnityEngine.RigidbodyType2D arg0 = (UnityEngine.RigidbodyType2D)LuaDLL.luaL_checknumber(L, 2);
			obj.bodyType = arg0;
			return 0;
		}
		catch(Exception e)
	...
	static int set_constraints(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Rigidbody2D obj = (UnityEngine.Rigidbody2D)o;
			UnityEngine.RigidbodyConstraints2D arg0 = (UnityEngine.RigidbodyConstraints2D)LuaDLL.luaL_checknumber(L, 2);
	...
	static int set_interpolation(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Rigidbody2D obj = (UnityEngine.Rigidbody2D)o;
			UnityEngine.RigidbodyInterpolation2D arg0 = (UnityEngine.RigidbodyInterpolation2D)LuaDLL.luaL_checknumber(L, 2);
	...
	static int set_sleepMode(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Rigidbody2D obj = (UnityEngine.Rigidbody2D)o;
			UnityEngine.RigidbodySleepMode2D arg0 = (UnityEngine.RigidbodySleepMode2D)LuaDLL.luaL_checknumber(L, 2);
			obj.sleepMode = arg0;
			return 0;
		}
		catch(Exception e)
	...
	static int set_collisionDetectionMode(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Rigidbody2D obj = (UnityEngine.Rigidbody2D)o;
			UnityEngine.CollisionDetectionMode2D arg0 = (UnityEngine.CollisionDetectionMode2D)LuaDLL.luaL_checknumber(L, 2);
