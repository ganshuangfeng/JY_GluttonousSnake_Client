...
public class DG_Tweening_SequenceWrap
{
	...
	static int SetUpdate(IntPtr L)
	{
		try
		{
			...
			else if (count == 2 && TypeChecker.CheckTypes<DG.Tweening.Tween, uint>(L, 1))
			{
				DG.Tweening.Sequence obj = (DG.Tweening.Sequence)ToLua.ToObject(L, 1);
				DG.Tweening.UpdateType arg0 = (DG.Tweening.UpdateType)LuaDLL.lua_tonumber(L, 2);
				DG.Tweening.Tween o = obj.SetUpdate(arg0);
				ToLua.PushObject(L, o);
				return 1;
			}
			...
			{
				DG.Tweening.Sequence obj = (DG.Tweening.Sequence)ToLua.CheckObject(L, 1, typeof(DG.Tweening.Sequence));
				DG.Tweening.UpdateType arg0 = (DG.Tweening.UpdateType)LuaDLL.luaL_checknumber(L, 2);
	...
	static int SetEase(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes<DG.Tweening.Tween, uint>(L, 1))
			{
				DG.Tweening.Sequence obj = (DG.Tweening.Sequence)ToLua.ToObject(L, 1);
				DG.Tweening.Ease arg0 = (DG.Tweening.Ease)LuaDLL.lua_tonumber(L, 2);
			...
			{
				DG.Tweening.Sequence obj = (DG.Tweening.Sequence)ToLua.CheckObject(L, 1, typeof(DG.Tweening.Sequence));
				DG.Tweening.Ease arg0 = (DG.Tweening.Ease)LuaDLL.luaL_checknumber(L, 2);
	...
	static int SetLoops(IntPtr L)
	{
		try
		{
			...
			else if (count == 3)
			{
				DG.Tweening.Sequence obj = (DG.Tweening.Sequence)ToLua.CheckObject(L, 1, typeof(DG.Tweening.Sequence));
				int arg0 = (int)LuaDLL.luaL_checknumber(L, 2);
				DG.Tweening.LoopType arg1 = (DG.Tweening.LoopType)LuaDLL.luaL_checknumber(L, 3);
