...
public class UnityEngine_UI_GridLayoutGroupWrap
{
	...
	static int set_startCorner(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.UI.GridLayoutGroup obj = (UnityEngine.UI.GridLayoutGroup)o;
			UnityEngine.UI.GridLayoutGroup.Corner arg0 = (UnityEngine.UI.GridLayoutGroup.Corner)LuaDLL.luaL_checknumber(L, 2);
	...
	static int set_startAxis(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.UI.GridLayoutGroup obj = (UnityEngine.UI.GridLayoutGroup)o;
			UnityEngine.UI.GridLayoutGroup.Axis arg0 = (UnityEngine.UI.GridLayoutGroup.Axis)LuaDLL.luaL_checknumber(L, 2);
			obj.startAxis = arg0;
			return 0;
		}
		catch(Exception e)
	...
	static int set_constraint(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.UI.GridLayoutGroup obj = (UnityEngine.UI.GridLayoutGroup)o;
			UnityEngine.UI.GridLayoutGroup.Constraint arg0 = (UnityEngine.UI.GridLayoutGroup.Constraint)LuaDLL.luaL_checknumber(L, 2);
			obj.constraint = arg0;
			return 0;
		}
		catch(Exception e)
