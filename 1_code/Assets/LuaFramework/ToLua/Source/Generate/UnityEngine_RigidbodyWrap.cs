	...
	static int DOLocalPath(IntPtr L)
	{
		try
		{
			...
			else if (count == 4)
			{
				...
				UnityEngine.Vector3[] arg0 = ToLua.CheckStructArray<UnityEngine.Vector3>(L, 2);
				float arg1 = (float)LuaDLL.luaL_checknumber(L, 3);
				DG.Tweening.PathType arg2 = (DG.Tweening.PathType)LuaDLL.luaL_checknumber(L, 4);
			...
			else if (count == 5)
			{
				...
				float arg1 = (float)LuaDLL.luaL_checknumber(L, 3);
				DG.Tweening.PathType arg2 = (DG.Tweening.PathType)LuaDLL.luaL_checknumber(L, 4);
				DG.Tweening.PathMode arg3 = (DG.Tweening.PathMode)LuaDLL.luaL_checknumber(L, 5);
	...
	static int DOLookAt(IntPtr L)
	{
		try
		{
			...
			else if (count == 4)
			{
				...
				UnityEngine.Vector3 arg0 = ToLua.ToVector3(L, 2);
				float arg1 = (float)LuaDLL.luaL_checknumber(L, 3);
				DG.Tweening.AxisConstraint arg2 = (DG.Tweening.AxisConstraint)LuaDLL.luaL_checknumber(L, 4);
	...
	static int DORotate(IntPtr L)
	{
		try
		{
			...
			else if (count == 4)
			{
				...
				UnityEngine.Vector3 arg0 = ToLua.ToVector3(L, 2);
				float arg1 = (float)LuaDLL.luaL_checknumber(L, 3);
				DG.Tweening.RotateMode arg2 = (DG.Tweening.RotateMode)LuaDLL.luaL_checknumber(L, 4);
