...
public class UnityEngine_UI_DropdownWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("AddOptionData", AddOptionData);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int AddOptionData(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
			UnityEngine.UI.Dropdown obj = (UnityEngine.UI.Dropdown)ToLua.CheckObject<UnityEngine.UI.Dropdown>(L, 1);
			UnityEngine.UI.Dropdown.OptionData arg0 = (UnityEngine.UI.Dropdown.OptionData)ToLua.CheckObject<UnityEngine.UI.Dropdown.OptionData>(L, 2);
			obj.AddOptionData(arg0);
			return 0;
		}
		catch (Exception e)
		{
