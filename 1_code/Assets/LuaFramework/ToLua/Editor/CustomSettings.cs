...
public static class CustomSettings
{
    ...
    {                
        ...
        _GT(typeof(MainVersion)),
        _GT(typeof(ColliderBehaviour)),

        //textmeshpro
        _GT(typeof(TMPro.TMP_Text)),
        _GT(typeof(TMPro.TextAlignmentOptions)),
        _GT(typeof(TMPro.TextContainer)),
        _GT(typeof(TMPro.TextElementType)),
        _GT(typeof(TMPro.TextMeshPro)),
        _GT(typeof(TMPro.TextMeshProUGUI)),


        _GT(typeof(DataInfo.Info)),
        _GT(typeof(DataInfo)),

        _GT(typeof(LuaInterface.PointTem)),
        _GT(typeof(LuaInterface.SizeTem)),
        _GT(typeof(LuaInterface.AStarPath)),
        _GT(typeof(AStar)),
