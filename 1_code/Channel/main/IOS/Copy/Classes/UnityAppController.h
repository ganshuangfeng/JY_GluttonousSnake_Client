...
@interface UnityAppController : NSObject<UIApplicationDelegate, WXApiDelegate, AVAudioRecorderDelegate, UINavigationControllerDelegate, UIImagePickerControllerDelegate,
